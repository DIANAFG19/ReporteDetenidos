...
<div class="container">	
 <div class="row">
	...
	<center><a class="btn btn-primary btn-lg sizeButton" href="registrar_main">Registrar</a></center>
	<br><br><br>
	<center><a class="btn btn-default btn-lg sizeButton" href="tramitar_main">Tramitar continuada</a></center>
	<br><br><br>
