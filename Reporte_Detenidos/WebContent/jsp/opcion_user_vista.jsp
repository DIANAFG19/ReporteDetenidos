...
<div class="container">	
 <div class="row">
	...
	<center><a class="btn btn-primary btn-lg sizeButton" href="registrar_user">Registrar</a></center>
	<br><br><br>
	<center><a class="btn btn-default btn-lg sizeButton" href="tramitar_user">Tramitar</a></center>
	<br><br><br>
	<center><a class="btn btn-success btn-lg sizeButton" href="reportes_user">Reportes de hoy y 3 días atrás</a></center>
