...
<div class="container">	
 <div class="row">
	...
	<br><br>
	<center><a class="btn btn-primary btn-lg sizeButton" href="registrar_main">Registrar otro</a></center>
	<br><br>
	<center><a class="btn btn-default btn-lg sizeButton" href="tramitar_main">Tramitar</a></center>
	<br><br>
	<center><a class="btn btn-success btn-lg sizeButton" href="reportes">Total Reportes</a></center>
