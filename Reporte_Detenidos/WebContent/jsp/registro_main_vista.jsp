  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav pull-right">
        <li class="active"><a href="registrar_main"><strong>Registrar</strong></a></li>
...
<div class="container">	
 <div class="row">
    ...
    <tag:form action="registrado" method="POST" modelAttribute="reporteFrm" class="form-horizontal" role="form">
