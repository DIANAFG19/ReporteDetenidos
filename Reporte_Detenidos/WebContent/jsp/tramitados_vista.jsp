  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav pull-right">
        ...
        <li><a href="tramitar_main">Tramitar</a></li>
        <li class="active"><a href="reportes"><strong>Total Reportes</strong></a></li>
        <%
...
<div class="container">	
 <div class="row">
	...
	<br><br>
	<center><a class="btn btn-danger" href="impresion_tramitados" target="_blank">Total</a></center>
