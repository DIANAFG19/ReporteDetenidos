  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav pull-right">
        <li><a href="registrar_user">Registrar</a></li>
        <li><a href="tramitar_user">Tramitar</a></li>
        <li class="active"><a href="reportes_user"><strong>Reportes de hoy (3 días atrás)</strong></a></li>
        <%
...
<div class="container">	
 <div class="row">
	...
	<%if(!rs.isBeforeFirst()) {%>           		
           		<center><h3>No hay reportes.</h3></center>
           <%} 
	else {    
           %>
	...
	<br><br>-->
	<center><a class="btn btn-danger" href="impresion_tramitadosPDF" target="_blank">Total</a></center>
