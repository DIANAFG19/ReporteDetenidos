  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav pull-right">
        ...
        <li class="active"><a href="tramitar_user"><strong>Tramitar</strong></a></li>
	...
	<div id="tablaReportes"><table class="table table-hover table-responsive" id="tablaIncidente">
           ...
           <%while(rs.next()){ %>
	       	<tr>
	       		...
	       		<th class="text-center"><a class="btn btn-warning btn-sm" href="editar_user?id=<%=rs.getInt("Id")%>">Dar Trámite</a></th>
	        </tr>
	       	 <%}%> 
           </table></div><br>
           <%} %>
