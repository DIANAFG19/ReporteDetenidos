...
public class Reporte {
	...
	public int getTotalImputados() {
		return totalImputados;
	}
	public void setTotalImputados(int totalImputados) {
		this.totalImputados = totalImputados;
	}
